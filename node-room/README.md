...
Este é um exemplo de implementação backend em Node.js utilizando a **WiseAPI** para gerenciamento de salas de videoconferência. O projeto demonstra como criar, abrir e entrar em salas utilizando uma API REST construída com Fastify.
...
- **Permitir que usuários entrem** nas salas
...
| Variável | Descrição | Exemplo |
|----------|-----------|---------|
| `WISE_ORG` | Organização responsável pela sala | `sua-organização` |
